"""
Django settings for cosmari project.
...
JWT_SECRET_KEY = os.getenv('SECRET_KEY', 'fallback_secret_key')
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-5vaxbkq7ldr*#o2302h7lhjnf95$nw3=)$50dseevtc4$9&2ix'
...
WSGI_APPLICATION = 'cosmari.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': (
      ...
      'DEFAULT_AUTHENTICATION_CLASSES': (
          'cosmari.authenticate.CustomAuthentication',
  )
...
SIMPLE_JWT = {
    ...
    #NUOVA CONFIGURAAZIONE AGGIUNTIVSA
